...
def plotError(myCond):
    ...
    if myCond == "R":
        ...
        ax1.loglog(numReps,absError[0,0,:],'b.-',linewidth=3,alpha = 0.8,label='$\lambda_1$')
        ax1.loglog(numReps,absError[1,1,:],'b.--',linewidth=3,alpha = 0.8,label='$\lambda_2$')
        ax1.loglog(numReps,absError[1,0,:],'k.-',linewidth=3,label='$\\nu_{12}$')
        ax1.loglog(numReps,absError[0,1,:],'k.--',linewidth=3,label='$\\nu_{21}$')
        ax1.set_xlabel("Number of experimental replicates",fontsize=15)
        ax1.set_ylabel("Absolute error of estimation",fontsize=15)
        ax1.tick_params(axis='x', labelsize=14)
        ax1.tick_params(axis='y', labelsize=14)
        ax1.legend(title="Parameter:",loc="upper right")

        ax2.loglog(numReps,relError[0,0,:],'b.-',linewidth=3,alpha = 0.8,label='$\lambda_1$')
        ax2.loglog(numReps,relError[1,1,:],'b.--',linewidth=3,alpha = 0.8,label='$\lambda_2$')
        ax2.loglog(numReps,relError[1,0,:],'k.-',linewidth=3,label='$\\nu_{12}$')
        ax2.loglog(numReps,relError[0,1,:],'k.--',linewidth=3,label='$\\nu_{21}$')
        ax2.set_xlabel("Number of experimental replicates",fontsize=15)
        ...
        fig.suptitle("Error of parameter estimates vs experimental replicates; mean of "+str(numRuns)+ " estimates", fontsize=15)
